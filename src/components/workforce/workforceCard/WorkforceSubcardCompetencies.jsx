...
class WorkforceSubcardCompetencies extends React.Component {
  render() {
    const { worker, competencies, role } = this.props;
    const realCompetencies = competencies.filter(
      comp => comp.competencyGroup === "Competencies"
    );
    ...
    const noComp = compRequired
      ...
      : competencies.find(
          comp =>
            ...
            comp.competencyGroup === "Competencies"
        );
    ...
    return (
      <Card
        title={<div className="card-header-wrapper">Competencies</div>}
        className="bordered"
      >
...
export default WorkforceSubcardCompetencies;
